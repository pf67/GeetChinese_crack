...
def parse_args():
    ...
    parser.add_argument('--dataset', dest='dataset', help='Trained dataset [voc_2007_trainval]',
...
if __name__ == '__main__':
    ...
    #demonent:vgg16  DATASETS[dataset][0]:voc_2007_trainval  NETS[demonet][0]:vgg16_faster_rcnn_iter_40000.ckpt
    # /output/vgg16/voc_2007_trainval/default/vgg16_faster_rcnn_iter_40000.ckpt
